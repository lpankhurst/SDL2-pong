...
void Window::drawBackground(SDL_Renderer* _renderer)
{
    SDL_SetRenderDrawColor(_renderer, 30, 30, 30, 255);
}

void Window::drawHalfwayLine(SDL_Renderer* _renderer)
{   
...
void Window::drawScores(SDL_Renderer* _renderer, TTF_Font* font, int player1Score, int player2Score)
{   
